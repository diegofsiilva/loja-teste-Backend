...
//        }
        //------------------------------------
        System.out.println("Prazer senhor bolinha do cpf: "+ cpf);

        System.out.println("Digite quantas camisetas vc quer: ");
        int vendido= Integer.parseInt(scanner.nextLine());

        System.out.println("Digite quantas camisetas vc repor: ");
        int reposto= Integer.parseInt(scanner.nextLine());

        System.out.println("Quantas camisetas tem no estoque: ");
        int estoqueInicial= Integer.parseInt(scanner.nextLine());
